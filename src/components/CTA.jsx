...
export default function CTA() {
  return (
    <section className="bg-gradient-to-br from-espresso via-forest to-pine py-20 text-white md:py-24">
      <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            ...
            className="inline-flex min-w-[220px] items-center justify-center rounded-2xl bg-white px-6 py-3.5 text-sm font-semibold text-forest transition hover:bg-white/90"
          >
            Claim Early Access
          </Link>
          <Link
